...
int main() {
    ...
    stare.T_exterior = get_temperatura(locatie.oras, locatie.data, 2);

    std::cout << stare.T_exterior;
...
void simulare(Camera& camera, Stare& stare, Locatie& locatie, double T_init){
